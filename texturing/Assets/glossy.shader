            ...
            else // light source on the right side
            {
              ...
              // specularReflection = attenuation * _LightColor0.rgb * _SpecColor.rgb * (1.0 - textureColor.a) 
                ...
                //  * pow(max(0.0, dot(reflect(-lightDirection, normalDirection), viewDirection)), _Shininess);
                  ...
                  //The land is also highlighted a bit. decreasing 0.8 will make the highlight stronger.
                  //Setting it to 1.0 will make only the water highlighted again.
                  //remember to change in both passes
                  //(1.0-0.2) = the minimum amount of gloss
                  specularReflection = attenuation * _LightColor0.rgb 
                  * _SpecColor.rgb * (1.0 - (1.0-0.2) * textureColor.a) 
                     // for usual gloss maps: "... * textureColor.a" 
                  * pow(max(0.0, dot(
